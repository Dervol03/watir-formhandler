...
module Watir
  describe Browser do
    ...
    describe '#fill_in' do
      describe 'without a start node', wip: true do
      ...
      describe 'with a start node' do
        it 'fills a Watir::Checkbox from start node'
        it 'fills a Watir::Radio from start node'
        it 'fills a Watir::Select from start node'
        it 'fills a Watir::TextField from start node'
        it 'fills a Watir::TextArea from start node'
        it 'fills a Watir::FileField from start node'
        it 'fills a Watir::OptionGroup from start node'
